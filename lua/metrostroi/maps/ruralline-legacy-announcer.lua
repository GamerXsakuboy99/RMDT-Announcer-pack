...
if Map:find("gm_metro_ruralline_v3") or Map:Find("gm_metro_ruralline_v4") then
    Metrostroi.PlatformMap = "museum_announcer"
    Metrostroi.CurrentMap = "museum_announcer"

    Metrostroi.AddANSPAnnouncer("[ENG]LVP Announcer 1989 | Museum Announcer by Concord", {
        -- Global sounds
        click1 = {"subway_announcers/asnp/click.mp3", 0.3},
        click2 = {"subway_announcers/asnp/click2.mp3", 0.1},
        -- Station sounds
