...
Metrostroi.AddANSPAnnouncer("[ENG + GER] LVP announcer 1995 | Valentin", {
    ...
    {
    {
        ...
        spec_wait = {"unss", 0.5, "unss_ger"},
        {
            900,
            "Market Street",
            arrlast = {{nil}, {"ann_start", "ths", "market", "doors_right", "trhm", 0.6, "ths_ger", "market_ger", "doors_right_ger", "trhm_ger", "click"}},
            dep = {{"ann_start", "doors_closing", "doors_closing_ger", "dro_cls", 1.0, "welc_lvp", "nx_st", "aviation", "platform_right", 0.2, "ravenholm_closed", 0.6, "welc_lvp_ger", "nx_st_ger", "aviation_ger", "platform_right_ger", 0.2, "ravenholm_closed_ger", "click"}, {nil}},
        },
        {
            902,
            "Aviation Uni.",
...
Metrostroi.AddANSPAnnouncer("[ENG + RU] LVP announcer 1995 | Tankict", {
    ...
    urban_ru = {"subway_announcers/v3_announcers/tankict_announcer/ru/stations/urban_park.mp3",1.475},
    ...
    nxt_st_ru = {"subway_announcers/v3_announcers/tankict_announcer/ru/special/next_station.mp3", 3.56},
...
}, {
    {
        ...
        },
        {
            ...
            dep = {{"dro_cls", 0.5, "train_goes", "rock", 0.3, "nxt_st", "urban", 0.5, "train_goes_ru", "rock_ru", 0.3, "nxt_st_ru", "city_ru", 0.3, "click"}, {"dro_cls", 0.5, "train_goes", "market", 0.3, "nxt_st", "city", 0.5, "train_goes_ru", "market_ru", 0.3, "nxt_st_ru", "city_ru", 0.3, "click"}},
        ...
        },
        {
            905,
            "Urban Park",
            arr = {{"ann_start","arrival","urban","mind_gap",0.5,"arrival_ru","urban_ru","mind_gap_ru"},{"ann_start","arrival","urban","mind_gap",0.5,"arrival_ru","urban_ru","mind_gap_ru"}},
