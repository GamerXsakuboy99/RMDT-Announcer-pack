...
print("=========================================================")
print("========RMDT Announcer loader: ruralline_legacy_v29_ansp Lua code Loading.========")
    ...
    {
        {
            ...
            },
            {
                902,"Aviation Uni.",
                arr = {
                    {"ann_start","ths","aviation","doors_right","mind_gap_step",0.5,"ths_ger","aviation_ger","doors_right_ger","mind_gap_step_ger","click"},
                    {"ann_start","ths","aviation","doors_right","mind_gap_step",0.5,"ths_ger","aviation_ger","doors_right_ger","mind_gap_step_ger","click"}
                },
                dep = {
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","city","platform_right",0.2,"nx_st_ger","city_ger","platform_right_ger","click"},
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","market","platform_right",0.2,"ravenholm_closed",0.5,"nx_st_ger","market_ger","platform_right_ger",0.2,"ravenholm_closed_ger","click"}
                },
            ...
            },
            {
                ...
                dep = {
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","white","platform_right",0.2,"nx_st_ger","white_ger","platform_right_ger","click"},
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","aviation","platform_right",0.2,"nx_st_ger","aviation_ger","platform_right_ger","click"}
                },
            },
            {
                904,"White Forest",
                arr = {
                    {"ann_start","ths","white","doors_right","mind_gap_step",0.5,"ths_ger","white_ger","doors_right_ger","mind_gap_step_ger","click"},
                    {"ann_start","ths","white","doors_right","mind_gap_step",0.5,"ths_ger","white_ger","doors_right_ger","mind_gap_step_ger","click"}
                },
                dep = {
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","urban","platform_right",0.2,"nx_st_ger","urban_ger","platform_right_ger","click"},
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","city","platform_right",0.2,"nx_st_ger","city_ger","platform_right_ger","click"}
                },
                arrlast = {
                    {"ann_start","ths","white","doors_both","trhm",0.5,"ths_ger","white_ger","doors_both_ger","trhm_ger","click"},
                    {"ann_start","ths","white","doors_right","trhm",0.5,"ths_ger","white_ger","doors_right_ger","trhm_ger","click"}
                },
            },
            {
                905,"Urban Park",
                arr = {
                    {"ann_start","ths","urban","doors_right","mind_gap_step",0.5,"ths_ger","urban_ger","doors_right_ger","mind_gap_step_ger","click"},
                    {"ann_start","ths","urban","doors_right","mind_gap_step",0.5,"ths_ger","urban_ger","doors_right_ger","mind_gap_step_ger","click"}
                },
                dep = {
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","rocklake","platform_right",0.2,"nx_st_ger","rocklake_ger","platform_right_ger","click"},
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"nx_st","white","platform_right",0.2,"nx_st_ger","white_ger","platform_right_ger","click"}
                },
                arrlast = {
                    {"ann_start","ths","urban","doors_right","trhm",0.5,"ths_ger","urban_ger","doors_right_ger","trhm_ger","click"},
                    {"ann_start","ths","urban","doors_right","trhm",0.5,"ths_ger","urban_ger","doors_right_ger","trhm_ger","click"}
                },
            },
            {
                906,"Rocklake",
                arrlast = {
                    {"ann_start","ths","rocklake","doors_right","trhm",0.5,"ths_ger","rocklake_ger","doors_right_ger","trhm_ger","click"},
                    {nil}
                },
                dep = {
                    {nil},
                    {"ann_start","doors_closing","doors_closing_ger","dro_cls",1.0,"welc_lvp","nx_st","urban","platform_right",0.2,"welc_lvp_ger","nx_st_ger","urban_ger","platform_right_ger","click"}
                },
            }
        }
    }
    ...
    {
        {
            ...
            spec_wait = {"ann_start", "fault"},
            {
                ...
                dep = {
                    {"ann_start","dro_cls",0.5,"next_st","aviation","click"},
                    {nil}
                },
            },
            {
                902, "Aviation Uni.",
                arr = {
                    {"ann_start","tis","aviation","click"},
                    {"ann_start","tis","aviation","click"}
                },
                dep = {
                    {"ann_start","dro_cls",0.5,"next_st","city","click"},
                    {"ann_start","dro_cls",0.5,"next_st","market","click"}
                },
                arrlast = {
                    {"ann_start","tis","aviation","eol","spec1","click"},
                    {"ann_start","tis","aviation","eol","spec1","click"}
                },
            },
            {
                ...
                dep = {
                    {"ann_start","dro_cls",0.5,"next_st","white","click"},
                    {"ann_start","dro_cls",0.5,"next_st","aviation","click"}
                },
            },
            {
                904, "White Forest",
                arr = {
                    {"ann_start","tis","white","click"},
                    {"ann_start","tis","white","click"}
                },
                dep = {
                    {"ann_start","dro_cls",0.5,"next_st","urban","click"},
                    {"ann_start","dro_cls",0.5,"next_st","city","click"}
                },
                arrlast = {
                    {"ann_start","tis","white","eol","spec1","click"},
                    {"ann_start","tis","white","eol","spec1","click"}
                },
            },
            {
                905, "Urban Park",
                arr = {
                    {"ann_start","tis","urban","click"},
                    {"ann_start","tis","urban","click"}
                },
                dep = {
                    {"ann_start","dro_cls",0.5,"next_st","rocklake","click"},
                    {"ann_start","dro_cls",0.5,"next_st","white","click"}
                },
                arrlast = {
                    {"ann_start","tis","urban","eol","spec1","click"},
                    {"ann_start","tis","urban","eol","spec1","click"}
                },
            },
            {
                906, "Rocklake",
                arrlast = {
                    {"ann_start","tis","rocklake","eol","spec1","click"},
                    {nil}
                },
                dep = {
                    {nil},
    ...
    {
        {
            ...
            spec_wait = {"terminal","click"},
            {
                ...
                arrlast = {
                    {nil},
                    {"chime","market","terminal","drc_rh","click"}
                },
                dep = {
                    {"chime","drc_cls",1.0,"chime","rh_pass","click"},
                    {nil}
                },
            },
            {
            ...
            },
            {
                ...
                arrlast = {
                    {"chime","white","terminal","drc_rh","click"},
                    {"chime","white","terminal","drc_rh","click"}
                },
            },
            {
                ...
                arrlast = {
                    {"chime","urban","terminal","drc_rh","click"},
                    {"chime","urban","terminal","drc_rh","click"}
                },
            },
            {
                902, "Rocklake",
                arrlast = {
                    {"chime","rocklake","terminal","drc_rh","click"},
                    {nil}
                },
                dep = {
                    {nil},
...
print("--------OUT OF ACTION: WAITING FOR RECORDING-----------")
    ...
    {
        {
            ...
            spec_wait = {"ann_start", "click"},
            {
                ...
                arrlast = {
                    {nil},
                    {"ann_start","market",0.3,"click"}
                },
                dep = {
                    {"dro_cls",1.0,"nxt_aviation","click"},
                    {nil}
                },
            },
            {
                902, "Aviation Uni.",
                arr = {
                    {"ann_start","aviation","click"},
                    {"ann_start","aviation","click"}
                },
                dep = {
                    {"dro_cls",1.0,"nxt_city","click"},
                    {"dro_cls",1.0,"nxt_market","click"}
                },
                arrlast = {
                    {"ann_start","aviation","click"},
                    {"ann_start","aviation","click"}
            ...
            },
            {
                904, "White Forest",
                arr = {
                    {"ann_start","white","click"},
                    {"ann_start","white","click"}
                },
                dep = {
                    {"dro_cls",1.0,"nxt_urban","click"},
                    {"dro_cls",1.0,"nxt_city","click"}
                },
                arrlast = {
                    {"ann_start","white","click"},
            ...
            },
            {
                905, "Urban Park",
                arr = {
                    {"ann_start","urban","click"},
                    {"ann_start","urban","click"}
                },
                dep = {
                    {"dro_cls",1.0,"nxt_rock","click"},
                    {"dro_cls",1.0,"next_white","click"}
                },
                arrlast = {
                    {"ann_start","urban","click"},
                    {"ann_start","urban","click"}
    ...
    {
        {
            ...
            spec_wait = {"ann_start","click"},
            {
                ...
                arrlast = {
                    {nil},
                    {"ann_start","arrival_end","market",0.5,"arrival_end_ru","market_ru"}
                },
                dep = {
                    {"dro_cls",0.5,"train_goes","rock",0.3,"nxt_st","aviation",0.5,"train_goes_ru","rock_ru",0.3,"nxt_st_ru","aviation_ru",0.3,"click"},
                    {nil}
                },
            },
            {
                902, "Aviation Uni.",
                arr = {
                    {"ann_start","arrival","aviation","mind_gap",0.5,"arrival_ru","aviation_ru","mind_gap_ru"},
                    {"ann_start","arrival","aviation","mind_gap",0.5,"arrival_ru","aviation_ru","mind_gap_ru"}
                },
                dep = {
                    {"dro_cls",0.5,"train_goes","rock",0.3,"nxt_st","city",0.5,"train_goes_ru","rock_ru",0.3,"nxt_st_ru","city_ru",0.3,"click"},
                    {"dro_cls",0.5,"train_goes","market",0.3,"nxt_st","market",0.5,"train_goes_ru","market_ru",0.3,"nxt_st_ru","market_ru",0.3,"click"}
                },
                arrlast = {
                    {"ann_start","arrival_end","aviation","mind_gap",0.5,"arrival_end_ru","aviation_ru","mind_gap_ru"},
                    {"ann_start","arrival_end","aviation","mind_gap",0.5,"arrival_end_ru","aviation_ru","mind_gap_ru"}
                },
            },
            {
                ...
                dep = {
                    {"dro_cls",0.5,"train_goes","rock",0.3,"nxt_st","white",0.5,"train_goes_ru","rock_ru",0.3,"nxt_st_ru","white_ru",0.3,"click"},
                    {"dro_cls",0.5,"train_goes","market",0.3,"nxt_st","aviation",0.5,"train_goes_ru","market_ru",0.3,"nxt_st_ru","aviation_ru",0.3,"click"}
                },
            },
            {
                904, "White Forest",
                arr = {
                    {"ann_start","arrival","white","mind_gap",0.5,"arrival_ru","white_ru","mind_gap_ru"},
                    {"ann_start","arrival","white","mind_gap",0.5,"arrival_ru","white_ru","mind_gap_ru"}
                },
                dep = {
                    {"dro_cls",0.5,"train_goes","rock",0.3,"nxt_st","urban",0.5,"train_goes_ru","rock_ru",0.3,"nxt_st_ru","city_ru",0.3,"click"},
                    {"dro_cls",0.5,"train_goes","market",0.3,"nxt_st","city",0.5,"train_goes_ru","city_ru",0.3,"nxt_st_ru","market_ru",0.3,"click"}
                },
                arrlast = {
                    {"ann_start","arrival_end","white","mind_gap",0.5,"arrival_end_ru","white_ru","mind_gap_ru"},
                    {"ann_start","arrival_end","white","mind_gap",0.5,"arrival_end_ru","white_ru","mind_gap_ru"}
                },
            },
            {
                905, "Urban Park",
                arr = {
                    {"ann_start","arrival","urban","mind_gap",0.5,"arrival_ru","urban_ru","mind_gap_ru"},
                    {"ann_start","arrival","urban","mind_gap",0.5,"urban_ru","aviation_ru","mind_gap_ru"}
                },
                dep = {
                    {"dro_cls",0.5,"train_goes","rock",0.3,"nxt_st","rock",0.5,"train_goes_ru","rock_ru",0.3,"nxt_st_ru","rock_ru",0.3,"click"},
                    {"dro_cls",0.5,"train_goes","market",0.3,"nxt_st","white",0.5,"train_goes_ru","market_ru",0.3,"nxt_st_ru","white_ru",0.3,"click"}
                },
                arrlast = {
                    {"ann_start","arrival","urban","mind_gap",0.5,"arrival_ru","urban_ru","mind_gap_ru"},
                    {"ann_start","arrival","urban","mind_gap",0.5,"urban_ru","aviation_ru","mind_gap_ru"}
            ...
            },
            {
                906, "Rocklake",
                arrlast = {
                    {"ann_start","arrival_end","rock","mind_gap",0.5,"arrival_end_ru","rock_ru","mind_gap_ru"},
                    {nil}
                },
                dep = {
                    {nil},
                    {"dro_cls",0.5,"train_goes","market",0.3,"nxt_st","urban",0.5,"train_goes_ru","market_ru",0.3,"nxt_st_ru","urban_ru",0.3,"click"}
                },
            }
        }
    }
