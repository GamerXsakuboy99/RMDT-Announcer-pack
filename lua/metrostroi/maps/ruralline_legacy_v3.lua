...
Metrostroi.AddANSPAnnouncer("[ENG + RU] LVP announcer 1995 | Tankict", {
...
}, {
    {
        ...
        BlockDoors = true,
        {
            ...
            dep = {{"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 2.0, "nxt_st", "aviation", 0.3, "nxt_st_ru", "aviation_ru", 0.5, "train_goes", "rock", 0.3, "train_goes_ru", "rock_ru", 0.3, "click"}, {nil}},
            have_inrerchange = true,
            right_doors = true,
        },
        {
            ...
            dep = {{"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 1.0, "nxt_st", "city", 0.3, "nxt_st_ru", "city_ru", 0.3, "click"}, {"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 2.0, "nxt_st", "market", 0.3, "nxt_st_ru", "market_ru", 0.3, "click"}},
        ...
        },
        {
            ...
            dep = {{"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 1.0, "nxt_st", "white", 0.3, "nxt_st_ru", "white_ru", 0.3, "click"}, {"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 1.0, "nxt_st", "aviation", 0.3, "nxt_st_ru", "aviation_ru", 0.3, "click"}},
            right_doors = true,
        },
        {
            904,
            ...
            dep = {{"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 1.0, "nxt_st", "urban", 0.3, "nxt_st_ru", "city_ru", 0.3, "train_goes", "rock", 0.3, "train_goes_ru", "rock_ru", 0.3, "click"}, {"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 1.0, "nxt_st", "city", 0.3, "next_st", "city_ru", 0.3, "train_goes", "market", 0.3, "train_goes_ru", "market_ru", 0.3, "click"}},
        ...
        },
        {
            ...
            dep = {{"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 2.0, "nxt_st", "rock", 0.3, "nxt_st_ru", "rock_ru", 0.3, "click"}, {"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 1.0, "nxt_st", "white", 0.3, "nxt_st_ru", "white_ru", 0.3, "click"}},
        ...
        },
        {
            ...
            dep = {{nil}, {"doors_close", 0.1, "doors_close_ru", 1.0, "dro_cls", 2.0, "nxt_st", "urban", 0.3, "nxt_st_ru", "urban_ru", 0.3, "train_goes", "market", 0.3, "train_goes_ru", "market_ru", 0.3, "click"}},
            have_inrerchange = true,
            right_doors = true,
        }
    }
...
Metrostroi.AddANSPAnnouncer("[ENG] LVP announcer 1995 | Rekrut Kurbel", {
...
}, {
    {
        ...
        BlockDoors = true,
        {
            ...
            dep = {{"doors_closing", 1.0, "next_station", "AV", 0.1, "spec_handrails"}, {nil}},
            have_inrerchange = true,
            right_doors = true,
        },
        {
            ...
            dep = {{"doors_closing", 1.0, "next_station", "CH"}, {"doors_closing", 1.0, "next_station", "MS", 0.1, "spec_handrails"}},
        ...
        },
        {
            ...
            dep = {{"doors_closing", 1.0, "next_station", "WF", 0.1, "spec_emergency"}, {"doors_closing", 1.0, "next_station", "AV"}},
            right_doors = true,
        },
        {
            904,
            ...
            dep = {{"doors_closing", 1.0, "next_station", "UP"}, {"doors_closing", 1.0, "next_station", "CH", 0.1, "spec_emergency"}},
        ...
        },
        {
            ...
            dep = {{"doors_closing", 1.0, "next_station", "RL", 0.1, "spec_handrails"}, {"doors_closing", 1.0, "next_station", "WF"}},
        ...
        },
        {
            ...
            dep = {{nil}, {"doors_closing", 1.0, "next_station", "UP", 0.1, "spec_handrails"}},
            have_inrerchange = true,
            right_doors = true,
        }
    }
...
Metrostroi.TickerAdverts = {"....No..Connection...to..Ticker..server..Error..505.....", "......................."}
